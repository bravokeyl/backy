...
function identityexperts_body_classes( $classes ) {
	...
	if ( is_customize_preview() ) {
		$classes[] = 'identityexperts-customizer';
	}

	// Add class on front page.
	if ( is_front_page() && 'posts' !== get_option( 'show_on_front' ) ) {
		$classes[] = 'identityexperts-front-page';
	}
...
function identityexperts_panel_count() {
...
function identityexperts_is_frontpage() {
