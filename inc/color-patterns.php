 ...
 */
function identityexperts_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'identityexperts_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.identityexperts-front-page) .entry-title,
...
.colors-custom .identityexperts-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.identityexperts-front-page .panel-content .recent-posts article,
...
.colors-custom.identityexperts-front-page article:not(.has-post-thumbnail):not(:first-child),
